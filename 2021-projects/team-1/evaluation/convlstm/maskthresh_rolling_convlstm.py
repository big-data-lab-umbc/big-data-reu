...
#load data
with open("convlstm_image_rolling_filled_preds.npy", "rb") as f:
	pred_ice = np.load(f)
with open("convlstm_image_rolling_filled_actual.npy", "rb") as f:
	real_ice = np.load(f)
...
with open("convlstm_rolling_pred_ice.npy", "wb") as f:
	np.save(f, pred_ice)
