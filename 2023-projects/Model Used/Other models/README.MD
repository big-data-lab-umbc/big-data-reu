1.	Bilinear interpolation: the goal is to estimate interpolated bedmachine value for each track pixel. It is the same process of doing bilinear interpolation for other variables.  
