...
#SBATCH --job-name=                                 
#SBATCH --mem=48G                                   
#SBATCH --nodes=                # num nodes: MUST match .yaml file
#SBATCH --gres=gpu:             # num gpus per node: MUST match .yaml file AND ntasks-per-node=
#SBATCH --ntasks-per-node=      # num gpus per node: MUST match .yaml file AND gres=gpu:
