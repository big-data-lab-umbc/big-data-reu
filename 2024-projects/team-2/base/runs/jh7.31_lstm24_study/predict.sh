#!/bin/bash
#SBATCH --job-name=jh7.31_lstm24_study                                  
#SBATCH --mem=48G                                   
...
# variables
run_id='jh7.31_lstm24_study'  # CHANGE THIS
...
cd - 
# do rest of run
srun python3 ../../eval/eval.py -o b -p eval/${run_id}/ -t logs/csv_logs/${run_id}/lightning_logs/version_0/
