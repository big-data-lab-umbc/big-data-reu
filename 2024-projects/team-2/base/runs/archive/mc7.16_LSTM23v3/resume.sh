#!/bin/bash
#SBATCH --job-name=LSTM3res                        # Job name
...
#SBATCH --error=slurm_output/slurm_res.err    # Error file name
#SBATCH --output=slurm_output/slurm_res.out   # Output file name

# variables- edit the first 3
