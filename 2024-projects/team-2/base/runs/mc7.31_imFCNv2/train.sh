...
#SBATCH --time=0-3:00:00       # Time limit days-hrs:min:sec
#SBATCH --error=slurm_output/slurm.err
#SBATCH --output=slurm_output/slurm.out

# variables  #SBATCH --constraint=rtx_6000   # see hpcf website
run_id='mc7.31_imFCNv2'  # CHANGE THIS
