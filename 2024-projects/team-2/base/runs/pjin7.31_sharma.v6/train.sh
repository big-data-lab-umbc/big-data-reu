#!/bin/bash
#SBATCH --job-name=pjin7.31_sharma.v6                                 
#SBATCH --mem=48G                                   
...
#SBATCH --time=1-05:00:00       # Time limit days-hrs:min:sec
#SBATCH --constraint=rtx_2080   # see hpcf website
#SBATCH --error=slurm_output/slurm.err
#SBATCH --output=slurm_output/slurm.out

# variables
run_id='pjin7.31_sharma.v6'  # CHANGE THIS
