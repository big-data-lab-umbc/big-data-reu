#!/bin/bash
#SBATCH --job-name=jh7.31_lstm24_study3                                 
#SBATCH --mem=48G                                   
...
#SBATCH --error=slurm_pred.err
#SBATCH --output=slurm_pred.out

# variables
run_id='jh7.31_lstm24_study3'  # CHANGE THIS
...
cd - 
# do rest of run
srun python3 ../../eval/eval.py -o b -p eval/${run_id}/ -t logs/csv_logs/${run_id}/lightning_logs/version_2/
