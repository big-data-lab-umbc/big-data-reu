#!/home/jpulido1/reu2024_team1/research/conda_env/feyn_env/bin/python3
"""
...
# feature names to be used in equation (the code below will change variable names to be consistent with these)
radar_names = ['Z', 'ZDR', 'KDP', 'RhoHV']

def get_symbolic_model(expr, feature_names=radar_names):
    # converts a string equation to a SymPy expression
...
def get_simplicity(simplified_expr):
    ...
    # compute simplicity as per srbench juding criteria by La Cava et al. (2021)
...
if __name__ == "__main__":
  ...
  main_df = pd.read_csv("/home/jpulido1/reu2024_team1/research/srbench_julian/srbench/experiment/datasets/all_cases_scaled.csv")
