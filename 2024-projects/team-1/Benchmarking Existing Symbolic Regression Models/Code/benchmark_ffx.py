...
def model(seed: int):
    ...
    # get best equation from model as string
    expr = str(model.model_).replace('^', '**')
    ...
    expr_sp = get_symbolic_model(expr)
    ...
    return {
        ...
        'all_nrmse': nrmse_all,
        'equation': expr, # return expression in string format because 'max' cannot be read directly from SymPy
...
if __name__ == "__main__":
    ...
    output.to_csv(f"benchmark_metrics_ffx.csv")
