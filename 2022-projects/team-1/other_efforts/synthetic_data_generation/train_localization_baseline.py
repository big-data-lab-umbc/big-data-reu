...
from models.localization_inceptionv3_baseline import getModel, getVersion
...
version = getVersion()
NAME = "{}-{}/{}/{}/{}".format(model_name, version, config["dataset_name"], config["transfer_label_set"], epochs)
